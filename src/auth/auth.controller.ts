...
import { RefreshTokenDto, TokenResponseDto, RevokeTokensResponseDto } from './dto/refresh.dto';
...
export class AuthController {
  ...
  @ApiResponse({ status: 200, description: 'Access token successfully refreshed', type: TokenResponseDto })
