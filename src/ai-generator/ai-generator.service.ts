...
export class AiGeneratorService {
    ...
    async generateSectionContent(
        ...
        const dynamicPrompt = this.constructDynamicPrompt(section.aiPrompt, variables);
        console.log('Dynamic Prompt:', dynamicPrompt);
        return this.openaiService.generateSectionContentGemini(dynamicPrompt);

    }

    private constructDynamicPrompt(prompt: string, variables: Record<string, string>): string {
